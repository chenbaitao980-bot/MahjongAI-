...
This project is indexed by GitNexus as **mahjong-learning** (6510 symbols, 12142 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
